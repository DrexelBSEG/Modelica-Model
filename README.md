...
* SimulinkRun: The MATLAB function (RunSimulinkValiDetail.m) used to call the Modelica fmu to run in the Simulink (SimuRun_Day1_Val.slx) under the control signal (AllValiData.mat)
