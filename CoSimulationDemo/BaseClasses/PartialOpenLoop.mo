within VirtualTestbed.NISTChillerTestbed.System.CoSimulationDemo.BaseClasses;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  CoSimulationDemo.ThermalZones.VAVBranch cor(
  ...
  CoSimulationDemo.ThermalZones.VAVBranch sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  CoSimulationDemo.ThermalZones.VAVBranch eas(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  CoSimulationDemo.ThermalZones.VAVBranch nor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  Buildings.Fluid.FixedResistances.Junction splRetSou(
    ...
    m_flow_nominal={mSou_flow_nominal + mEas_flow_nominal + mNor_flow_nominal,
            mEas_flow_nominal + mNor_flow_nominal,
            mSou_flow_nominal},
    from_dp=false,
    linearized=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
  ...
  Buildings.Fluid.FixedResistances.Junction splRetEas(
    redeclare package Medium = MediumA,
    m_flow_nominal={mEas_flow_nominal + mNor_flow_nominal,
        mNor_flow_nominal,mEas_flow_nominal},
    from_dp=false,
    linearized=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    dp_nominal(each displayUnit="Pa") = {0,0,0},
  ...
  Buildings.Fluid.FixedResistances.Junction splSupSou(
    redeclare package Medium = MediumA,
    m_flow_nominal={mSou_flow_nominal + mEas_flow_nominal + mNor_flow_nominal,
    mEas_flow_nominal + mNor_flow_nominal,mSou_flow_nominal},
    from_dp=true,
    linearized=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState,
    dp_nominal(each displayUnit="Pa") = {0,0,0},
  ...
  Modelica.Blocks.Routing.DeMultiplex4 TRooAir(u(each unit="K", each
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupNor_flow(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={1100,132})));
  CoSimulationDemo.BaseClasses.MixingBox eco(
    redeclare package Medium = MediumA,
...
equation
  ...
  connect(splRetRoo1.port_3, flo.portsCor[2]) annotation (Line(
      points={{640,10},{640,472},{824,472},{824,510.125},{824.48,510.125}},
      color={0,127,255},
      thickness=0.5));
  connect(splRetSou.port_3, flo.portsSou[2]) annotation (Line(
      points={{822,10},{822,451},{824.48,451}},
      color={0,127,255},
      thickness=0.5));
  connect(splRetEas.port_3, flo.portsEas[2]) annotation (Line(
      points={{1002,10},{1002,368},{1040.96,368},{1040.96,510.125}},
      color={0,127,255},
      thickness=0.5));
  connect(flo.TRooAir, min.u) annotation (Line(
      points={{1108.2,512.875},{1164.7,512.875},{1164.7,450},{1198,450}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(flo.TRooAir, ave.u) annotation (Line(
      points={{1108.2,512.875},{1166,512.875},{1166,420},{1198,420}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(TRooAir.u, flo.TRooAir) annotation (Line(
      points={{488,170},{480,170},{480,538},{1164,538},{1164,512.875},{1108.2,512.875}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  ...
  connect(VSupCor_flow.port_b, flo.portsCor[1]) annotation (Line(
      points={{580,140},{580,480},{808.08,480},{808.08,510.125}},
      color={0,127,255},
      thickness=0.5));

  connect(VSupSou_flow.port_b, flo.portsSou[1]) annotation (Line(
      points={{760,140},{760,356},{808.08,356},{808.08,451}},
      color={0,127,255},
      thickness=0.5));
  connect(VSupEas_flow.port_b, flo.portsEas[1]) annotation (Line(
      points={{940,138},{940,376},{1024.56,376},{1024.56,510.125}},
      color={0,127,255},
      thickness=0.5));
  connect(VSupNor_flow.port_b, flo.portsNor[1]) annotation (Line(
      points={{1100,142},{1100,626},{808.08,626},{808.08,567.875}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(heaCoi.port_b1, sinHea.ports[1]) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(splSupEas.port_2, nor.port_a) annotation (Line(points={{950,-40},{1100,
          -40},{1100,20}}, color={0,127,255}));
  connect(splRetEas.port_2, flo.portsNor[2]) annotation (Line(points={{1012,0},{
          1140,0},{1140,612},{824.48,612},{824.48,567.875}}, color={0,127,255}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -100},{100,160}})),  Documentation(info="<html>
<p>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
    ...
    Icon(coordinateSystem(extent={{-120,-100},{100,160}})));
end PartialOpenLoop;
